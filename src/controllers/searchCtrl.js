const { create: lcreate, insert: linsert, remove: lremove, search: lsearch } = require("@lyrasearch/lyra");
const { persistToFile, restoreFromFile } = require("@lyrasearch/plugin-data-persistence");
const path = require("path");
const fs = require("fs");
const { eventsToHandle } = require("../data/brain");
...
class SearchCtrl {
    constructor() {
        ...
        */
         ...
         * @type {string}
        */
        this.dataPath = path.resolve() + '/searchData/';
        /**
    ...
    */
     ...
     * 
     * @async
     * @returns {Promise<string>} - Returns a string indicating that the search controller has been started
    */
    async start() {
        ...
        return 'Search controller started';
    }
